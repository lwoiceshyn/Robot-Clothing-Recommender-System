...
class BehaviorModule(ALModule):
    ...
    def screen_transition_client(self, screen_name):
        '''
        ROS client which tells the touchscreen to transition to the next screen
        '''
    ...
    def recommendations_client(self):
        '''
        ROS client which recommends clothing from the clothing FSM
        '''
    ...
    def handle_featuretype(self, req):
        '''
        ROS Server response to the activity type information
        '''
    ...
    def featuretype_server(self):
        '''
        ROS Server which waits for the activity type information from the touchscreen
        '''
        global stop_spinning
        stop_spinning = False  
        try:
    ...
    def handle_waitnext(self, req):
        '''
        ROS Server response to next command
        '''
        global stop_spinning
    ...
    def waitnext_server(self):
        '''
        ROS Server which runs the next command
        '''
        global stop_spinning
        stop_spinning = False  
        try:
    ...
    def handle_waitacceptance(self,req):
        '''
        ROS Server response to whether the user accepted or rejected the outfit
        '''
        global stop_spinning
    ...
    def waitacceptance_server(self):
        '''
        ROS Server which waits for information on user accepting/rejecting outfit
        '''
        global stop_spinning
        stop_spinning = False  
        try:
    ...
    def handle_waitreplace(self,req):
        '''
        ROS Server response to information about which clothing items the user is replacing
        '''
        global stop_spinning
    ...
    def waitreplace_server(self):
        '''
        ROS Server which waits for information about which clothing items the user is replacing
        '''
        global stop_spinning
        stop_spinning = False  
        try:
    ...
    def handle_username(self,req):
        '''
        ROS Server response to the user's name associated with their profile
        '''
        global stop_spinning
    ...
    def username_server(self):
        '''
        ROS Server which waits for the user's profile being chosen on the touchscreen
        '''
        global stop_spinning
        stop_spinning = False  
        try:
    ...
    def check_featuretype(self):
        '''
        Checks whether user is choosing a preset activity or choosing manual features
        '''
        if feature_type == 0:
    ...
    def reset_replace(self):
        '''
        Resets the current clothing items which are up for replacement
        '''
        replace['all'] = None
        replace['upper'] = None
        replace['lower'] = None
    ...
    def introduction(self):
        '''
        Robot introduces itself and explains things.
        '''
    ...
    def individual_features(self):
        '''
        Robot requests information about daily activity plan
        '''
    ...
    def wait_first_feature(self):
        '''
        Waits for information on user activity being selected on touchscreen
        '''
    ...
    def comfort(self):
        '''
        Robot requests information about user's comfort level
        '''
        self.breathing_off()
    ...
    def wait_second_feature(self):
        '''
        Waits for information on comfort level being selected on touchscreen
        '''
        self.waitnext_server()
    ...
    def inside_outside(self):
        '''
        Robot requests information about user's activity being inside or outside
        '''
        self.breathing_off()
    ...
    def wait_third_feature(self):
        '''
        Waits for inside/outside information being selected on touchscreen
        '''
        self.waitnext_server()
    ...
    def casual_formal(self):
        '''
        Robot requests information about user's dress code
        '''
        self.breathing_off()
    ...
    def wait_fourth_feature(self):
        '''
        Waits for information about dress code
        '''
        self.waitnext_server()
    ...
    def generate_recommendation(self):
        '''
        Robot relays recommendation to user
        '''
        global first_runthrough
        self.breathing_off()
    ...
    def wait_next(self):
        '''
        Robot lets user look over the outfit on the touchscreen
        '''
        self.breathing_off
    ...
    def ask_feedback(self):
        '''
        Robot asks for feedback on the outfit
        '''
        self.breathing_off()
    ...
    def respond_rejection(self):
        '''
        Robot responds to user rejecting the outfit
        '''
        self.breathing_off()
    ...
    def respond_acceptance(self):
        '''
        Robot responds to user accepting the outfit
        '''
        self.breathing_off()
    ...
    def respond_replace(self):
        '''
        Robot responds to user replacing clothing items from the outfit
        '''
        self.breathing_off()
        if replace['all'] == 1:
    ...
    def closing_remarks(self):
        '''
        Robot says its closing remarks to the user
        '''
        self.breathing_off()
    ...
    def wake(self):
        '''
        Robot responds to user starting interaction with touchscreen
        '''
        self.waitnext_server()
        self.motion.wakeUp() 
    ...
    def say_contextual(self, text):
        ...
        Robot text-to-speech with automatic contextual gestures applied
        '''
    ...
    def say_animated(self, text):
        ...
        Robot text-to-speech with custom robot gestures applied
        '''
        self.atts.say(text)
    ...
    def say_post(self, text):
        ...
        Robot text-to-speech multi-threaded response. Runs on top of behavior
        '''
        self.tts.post.say(text)
    
    def neutral(self):
        '''
        Robot goes to standing posture
        '''
    ...
    def reset_eyes(self):
        '''
        Robot resets its eye LEDs
        '''
        self.leds.fadeRGB("LedEye", "white", 0.5)
    
    def create_eye_leds(self):
        '''
        Creates different LED groups on robot
        '''
    ...
    def breathing_on(self):
        '''
        Turns robot breathing animation on
        '''
    ...
    def breathing_off(self):
        '''
        Turns robot breathing animation off
        '''
        self.facetrack_off()
    ...
    def beckon(self):
        '''
        Custom coded animation where the robot gestures towards the touchscreen
        '''
